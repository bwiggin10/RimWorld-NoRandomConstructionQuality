...
namespace NoRandomConstructionQuality
{
    ...
    public static class Initializer
    {
        static Initializer()
        {
            ...
            {
                Log.Message("NoRandomConstructionQuality: QualityUtility.RandomCreationQuality failed to override, please report to mod author");
            }
            ...
            {
                Log.Message("NoRandomConstructionQuality: QualityUtility._SendCraftNotification failed to override, please report to mod author");
            }
        }
    }
}
